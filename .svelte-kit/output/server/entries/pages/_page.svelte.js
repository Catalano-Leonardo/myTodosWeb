...
function Icon($$payload, $$props) {
  ...
  $$payload.out += `<span class="material-icons-outlined icon svelte-kcqy11"${attr("style", `--color:${stringify(color)};`)}>${escape_html(name)}</span>`;
...
function Priority($$payload, $$props) {
  ...
  $$payload.out += `<span${attr("class", `${stringify(disabled ? "DISABILITATO" : prio2str(prio))} svelte-necsms`)}>${escape_html(prio2str(prio))}</span>`;
  bind_props($$props, { prio, disabled });
}
function Cell($$payload, $$props) {
  let last = fallback($$props["last"], false);
  $$payload.out += `<div${attr("class", `cell ${stringify(last ? "cell-last" : "")} svelte-1rok9x2`)}><!---->`;
...
function Todo_list($$payload, $$props) {
  ...
  $$payload.out += `<h1 class="app-title svelte-n75paq">ToDos</h1> <div class="todo-list svelte-n75paq"><div class="header svelte-n75paq">`;
  Icon($$payload, { name: "tag" });
  $$payload.out += `<!----></div> <div class="header svelte-n75paq">`;
  Icon($$payload, { name: "task_alt" });
  $$payload.out += `<!----></div> <div class="header svelte-n75paq">`;
  Icon($$payload, { name: "list" });
  $$payload.out += `<!----></div> <div class="header svelte-n75paq">`;
  Icon($$payload, { name: "schedule" });
  $$payload.out += `<!----></div> <div class="header header-last svelte-n75paq">`;
